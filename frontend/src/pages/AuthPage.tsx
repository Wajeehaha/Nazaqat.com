      ...
      <div className="w-32 h-32 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-400">
        ...
        <Card className="w-full shadow-lg border-slate-200">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-center">Welcome to Nazakat Nails</CardTitle>
            <CardDescription className="text-center">
              {activeTab === "login"
                ? "Enter your credentials to access your nail collection"
                : "Create an account to start your nail journey"}
            </CardDescription>
          </CardHeader>
