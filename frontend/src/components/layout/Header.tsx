...
import logo from "@/pages/logo.jpeg"; // Import the logo from the pages directory
              ...
              <SheetContent side="right" className="w-[85%] sm:w-[385px]">
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <Link to="/cart" className="flex items-center space-x-3 p-3 hover:bg-gray-100 rounded-md transition-colors">
                    ...
                    {totalItems > 0 && (
                      <span className="bg-black text-white rounded-full w-6 h-6 flex items-center justify-center text-xs ml-auto">
                        {totalItems}
                      </span>
                    )}
                  </Link>
